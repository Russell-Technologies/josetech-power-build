    ...
    <footer className="bg-[#111] text-[#bbb]">
      <div className="mx-auto max-w-[1280px] px-6 py-16 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="text-[13px] leading-relaxed">
            ...
            Certified. Trusted. On time.
          </p>
          <div className="flex gap-2 mt-5">
            {["F", "in", "IG", "X"].map((s) => (
              <span
                key={s}
                className="flex h-9 w-9 items-center justify-center bg-[#1a1a1a] text-white text-xs font-bold rounded"
              >
                {s}
              </span>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-3 text-[13px]">
            <li className="flex gap-2">
              <span className="text-[#e5193a]">•</span>14 Adeyemi Lawson Street, Victoria Island,
              Lagos
            </li>
            <li className="flex gap-2">
              <span className="text-[#e5193a]">•</span>info@josetech.ng
            </li>
            <li className="flex gap-2">
              <span className="text-[#e5193a]">•</span>+234 803 000 0000
            </li>
            <li className="flex gap-2">
              <span className="text-[#e5193a]">•</span>Mon–Fri: 8am–6pm · Sat: 9am–2pm
            </li>
      ...
      <div className="bg-[#0a0a0a] text-[#888]">
        <div className="mx-auto max-w-[1280px] px-6 py-4 flex flex-col md:flex-row justify-between gap-2 text-[12px]">
          <div>
            © 2026 Josetech Power Consultant & Appliances Limited. All rights reserved. RC 8893411
          </div>
